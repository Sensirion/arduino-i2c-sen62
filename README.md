# Sensirion I²C SEN62 Arduino Library

This is the Sensirion SEN62 library for Arduino allowing you to
communicate with a SEN62 sensor
over I²C.
...
Search for the `Sensirion I2C SEN62` library in the `Filter
...
Use the following pin description to connect your SEN62 to the standard I²C bus of your Arduino board:
...
| *SEN62* | *SEN62 Pin* | *Cable Color* | *Board Pin* |
| :---: | --- | --- | --- |
| VDD | 1 | red | 3.3V |
| GND | 2 | black | GND |
| SDA | 3 | green | D18/SDA |
...
2. Connect the SEN62 sensor to your Arduino as explained in [Connect the sensor](#connect-the-sensor)

3. Open the `exampleUsage` sample project within the Arduino IDE:

   `File` ➔ `Examples` ➔ `Sensirion I2C SEN62` ➔ `exampleUsage`
